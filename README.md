...
**Live:** [megabomb420.github.io/anime-buddy](https://megabomb420.github.io/anime-buddy/) · **v0.3.29**
...
| **Profile** | Taste DNA (Worker blurb on Rebuild), spoiler level, age gate, Worker override, **Import from AniList** (public list → preview → confirm → library + ratings), hidden titles, data export. |
