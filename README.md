...
**Live:** [megabomb420.github.io/anime-buddy](https://megabomb420.github.io/anime-buddy/) · **v0.3.33**
...
| **Profile** | Taste DNA (Worker blurb on Rebuild) with a **genre weight chart**, **You vs the crowd** scatter (your score vs AniList), **Share** → a 1080×1350 PNG card (summary + top genres + stats, system share sheet or download), spoiler level, age gate, Worker override, **Import from AniList** (public list → preview → confirm → library + ratings), hidden titles, data export. |
