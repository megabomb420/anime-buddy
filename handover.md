...
| Surface | State |
| --- | --- |
| Pages | **v0.3.32** — `version.json` must match `package.json` |
...
If the phone still shows an old footer: clear site data for `megabomb420.github.io`. Footer must read **v0.3.32**.
...
2. Shareable Taste DNA card (canvas → PNG).
