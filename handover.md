...
2. Polish write-intent variants for the 0.3.23 actions (favorite/note/remove/rewatch) — currently EN-only.
3. Verify the Taste DNA share card renders well on a real phone (canvas fonts + share sheet).
