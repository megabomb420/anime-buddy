...
**Date:** 2026-08-24  
**App version:** `0.3.3` (see Profile → App version + `version.json` on Pages)  
...
- `package.json` → semver shown in UI (`0.3.3`+)
...
2. Profile → **App version** shows `v0.3.3` (or current) and *latest* or *update*.
